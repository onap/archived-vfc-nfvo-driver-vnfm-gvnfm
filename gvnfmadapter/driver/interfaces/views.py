...
from driver.interfaces.serializers import VnfOperRespSerializer, VnfGrantReqSerializer, VnfGrantRespSerializer, HealVnfRequestSerializerToVnfm
...
class VnfHealView(APIView):
    ...
    def post(self, request, vnfmtype, vnfmid, vnfInstanceId):
        ...
        try:
            ...
            if not resp_isvalid:
                raise GvnfmDriverException(probDetail.errors)
